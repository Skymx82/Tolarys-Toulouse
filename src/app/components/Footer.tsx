...
export default function Footer() {
  return (
    ...
    >
      ...
      <div className="absolute opacity-25 top-0 right-0">
        <Image
          ...
          <motion.div variants={itemVariants} className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center gap-2">
                ...
                <span className="text-gray-300">tolarystoulouse@gmail.com</span>
              </li>
              <li className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-rose-toulouse" viewBox="0 0 20 20" fill="currentColor">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <span className="text-gray-300">+33 6 79 33 68 12</span>
              </li>
            </ul>
            
            {/* Réseaux sociaux */}
            <div className="mt-6 flex gap-4">
              <a href="https://www.facebook.com/tolarystoulouse" className="text-gray-300 hover:text-rose-toulouse transition-colors z-30">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path>
                </svg>
              </a>
              <a href="#" className="text-gray-300 hover:text-rose-toulouse transition-colors z-30">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
